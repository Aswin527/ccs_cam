                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="subtitle" value="{{ $data->subtitle }}" id="formrow-email-input">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="hidden" class="form-control" name="id" value="{{ $data->id }}" id="formrow-email-input">
                                </div>
                            </div>
