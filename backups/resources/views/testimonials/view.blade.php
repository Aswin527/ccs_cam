                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <form action="{{ url('/home/testimonials/store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @if (count($errors) > 0)
                        <div class="alert alert-danger">
                            <ul>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="designation" value="{{ old('subtitle') }}" id="formrow-email-input">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($data as $data)
                                                    <tr>
                                                        ...
                                                        <td><a href="/home/testimonials/delete/{{$data->id}}" class="btn btn-danger waves-effect btn-label waves-light"><i class="mdi mdi-trash-can label-icon"></i> Delete</a>
                                                        <a href="/home/testimonials/edit/{{$data->id}}" class="btn btn-warning waves-effect btn-label waves-light"><i class="bx bx-edit-alt label-icon"></i> Edit</a>
                                                        </td>
