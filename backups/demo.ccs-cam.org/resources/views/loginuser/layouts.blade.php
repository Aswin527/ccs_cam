                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.html" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                    <img src="/admin_assets/images/logo-sm.svg" alt="" height="24"> <span class="logo-txt">CCS</span>
                                </span>
                            </a>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="@if(Auth::user()) /images/{{Auth::user()->photo}} @else /admin_assets/images/users/avatar-1.jpg @endif"
                                    alt="Header Avatar">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium">@if(Auth::user()) {{Auth::user()->firstname}} @else  CCS @endif</span>
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <!--        <span data-key="t-dashboard">Organization</span>-->
                            <!--    </a>-->
                            <!--</li>-->
                            <li>
                             ...
                             <li>
                                <a href="/user/membership/card">
                                   <i class="bx bx-grid-vertical"></i>
                                    <span data-key="t-dashboard">Membership Card</span>
                                </a>
                            </li>
...
<!-- Mirrored from themesbrand.com/minia/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Mar 2024 04:57:53 GMT -->
</html>